...
def build_embedding_matrix(word2idx, embed_dim, type):
    ...
    if os.path.exists(embedding_matrix_file_name):
        ...
        fname = './datasets/glove/glove.42B.300d.txt'
...
class ABSADatesetReader:
    ...
    def __init__(self, dataset='twitter', embed_dim=300, model_name = None,\
                 max_seq_len = None, pretrained_bert_name = None):
