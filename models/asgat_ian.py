...
class ASGAT_IAN(nn.Module):
    def __init__(self, embedding_matrix, opt):
        super(ASGAT_IAN, self).__init__()
        self.opt = opt
        ...
        self.attention_aspect = Attention(opt.hidden_dim, n_head=24, score_function='bi_linear')
        self.attention_context = Attention(opt.hidden_dim, n_head=24, score_function='bi_linear')
        self.gat2v = GATv2Conv(opt.hidden_dim, opt.hidden_dim, heads=4, concat=False)
